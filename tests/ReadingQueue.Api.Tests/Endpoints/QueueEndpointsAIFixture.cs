...
public class QueueEndpointsAIFixture : IAsyncLifetime
{
    ...
    private const string JwtSecret   = "test-secret-key-for-queue-ai-integration-tests-32c";
    ...
    public QueueEndpointsAIFixture()
    {
...
#pragma warning restore CS0618
        ...
        Factory = new WebApplicationFactory<Program>()
            .WithWebHostBuilder(b => b.ConfigureAppConfiguration((_, cfg) =>
                cfg.AddInMemoryCollection(new Dictionary<string, string?>
                {
                    ...
                    ["Claude:BaseUrl"]         = WireMock.Url!,
                    ["Claude:MaxRetries"]      = "0",
                    ["Claude:TimeoutSeconds"]  = "2",
                })));
    }
    ...
    public static CreateBookRequest DefaultBook(int priority = 3) => new(
